...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(77, 205);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(126, 24);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Hello World!";
			this->label1->Click += gcnew System::EventHandler(this, &WindowsForm::label1_Click_1);
			// 
			// pictureBox1
			// 
			this->pictureBox1->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.Image")));
			this->pictureBox1->Location = System::Drawing::Point(81, 90);
